...
<ul class="layui-nav layui-nav-tree layui-inline" lay-filter="demo"
    ...
    <li class="layui-nav-item"><svg  viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
        <circle cx="50" cy="50" r="50"  stroke="#001428" stroke-width="35" fill="#2D3B91"/>Admin
    </svg></li>
    ...
    <li class="layui-nav-item">
        ...
        <dl class="layui-nav-child">
            ...
            <dd><a href="../department/getemployees">User query</a></dd>
        </dl>
    </li>

    <li class="layui-nav-item"><a href="">Exit</a></li>
